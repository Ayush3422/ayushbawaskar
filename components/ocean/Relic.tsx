 ...
 *
 * 97 source frames at 13 MB became 49 frames in a 257 KB animated WebP: every
 * other frame at 520px. A full rotation survives the halving; the file size
 * does not.
 */
  ...
  return (
    ...
    >
      ...
      <img
        ...
        height={509}
        decoding="async"
        className="h-auto w-[min(78vw,42rem)] max-w-none"
        style={{
          mixBlendMode: "screen",
