/**
 * Inline marks rather than an icon package.
 *
 * lucide-react is already a dependency, but v1 removed its brand icons —
 * Github and Linkedin no longer exist there. Mixing a stroke-drawn envelope
 * from lucide with filled brand glyphs would also read as two different icon
 * sets, so all three are drawn here as fills at the same 24px grid.
 */
...
export function MailIcon({ className = "" }: IconProps) {
  return (
    ...
    >
      <path d="M22 4H2a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1Zm-1.6 2L12 12.13 3.6 6h16.8ZM3 18V7.24l8.42 6.15a1 1 0 0 0 1.16 0L21 7.24V18H3Z" />
    </svg>
  );
}
...
/** The mark for a given contact label, or null if there is no obvious one. */
export function iconFor(label: string) {
  const key = label.toLowerCase();
  if (key.includes("mail")) return MailIcon;
