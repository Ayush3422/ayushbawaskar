...
export function DiveComputer() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className="hard-shadow fixed right-4 bottom-4 z-40 w-[11.5rem] border-2 border-border bg-card/90 p-3 font-mono backdrop-blur transition-opacity duration-200 hover:opacity-15 md:right-6 md:bottom-6 md:p-4"
    >
